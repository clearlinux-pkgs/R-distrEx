...
Version  : 2.9.6
Release  : 47
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/distrEx_2.9.6.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/distrEx_2.9.6.tar.gz
...
%setup -q -n distrEx
pushd ..
cp -a distrEx buildavx2
popd
pushd ..
cp -a distrEx buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736816942
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/distrEx/libs/distrEx.so
/V4/usr/lib64/R/library/distrEx/libs/distrEx.so
